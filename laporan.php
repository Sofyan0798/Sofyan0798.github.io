...
?>
	...
	<div>
	  ...
	  <div class="tab-content">
	    <div role="tabpanel" class="tab-pane active" id="rangking">
	    	<br/>
	    	<h4>Nilai Siswa Kriteria</h4>
			<table width="100%" class="table table-striped table-bordered">
		        <thead>
		            <tr>
		                <th rowspan="2" style="vertical-align: middle" class="text-center">Daftar siswa</th>
	...
	<footer class="text-center">copyright @Smk.Islam_Annur_losari; 2022</footer>
	</div>
    ...
    <script>
    	$('#cetak').click(function() {
    		...
    		$("#rangking").printMe({ "path": "css/bootstrap.min.css", "title": "LAPORAN CALON PENERIMA BEASISWA SMK ISLAM ANNUR LOSARI " }); 
