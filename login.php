...
<html lang="en">
  ...
  <style>
body {
  background-image: url('bckgrnd_smk.jpg');
	...
	<nav class="navbar navbar-inverse navbar-static-top">
	  <div class="container">
		...
		<div class="navbar-header">
		  ...
		  <a class="navbar-brand" href=""> SMK Islam Annur losari</a>
		</div>

		<!-- Collect the nav links, forms, and other content for toggling -->
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  <ul class="nav navbar-nav navbar-right">
			<li><a href="https://www.instagram.com/smkislamannur03/?hl=id"  target="_blank"><img src="ig.png" height="15 px" width="15 px">   SMK Islam ANNUR Losari</a></li>
		  </ul>
		</div><!-- /.navbar-collapse -->
	  </div><!-- /.container-fluid -->
	</nav>
